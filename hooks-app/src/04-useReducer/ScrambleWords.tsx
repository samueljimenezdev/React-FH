...
import { getInitialScrambleWordState, scrambledWordReducer } from './reducer/scramble-word.reducer';

export const ScrambleWords = () => {

    const [state, dispatch] = useReducer(scrambledWordReducer, getInitialScrambleWordState());
                    ...
                    <CardContent className="p-8">
                        ...
                        <div className="mb-8">
                            <h2 className="text-center text-sm font-medium text-gray-500 mb-4 uppercase tracking-wide flex items-center justify-center gap-2">
                                Palabra Desordenada
                                {state.isGameOver && (
                                    <span className="text-red-500 text-xl"> {state.currentWord}</span>
                                )}
                            </h2>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        value={state.guess}
                                        onChange={(e) =>
                                            dispatch({ type: 'SET_GUESS', payload: e.target.value.toUpperCase() })
                                        }
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 text-center border border-green-200">
                                <div className="text-2xl font-bold text-green-600">
                                    {state.points} / {state.lengthWords}
                                </div>
